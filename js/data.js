/* =========================================================
   ...
   Aquí guardamos toda la información del itinerario:
   - días
   - actividades
   - trayectos
   - coordenadas
   ...
   app.js se encargará de mostrar estos datos.
========================================================= */
...
const tripDays = [
...

  {
    ...
    /* =====================================================
       ...
       El orden del array es el orden del día.
    ===================================================== */
    ...
    activities: [
...

      {
        ...
        offlineDirections: [
          ...
          "Seguir las indicaciones hacia el Visitor Center y P1 Hakið."
        ...
        parking: {
          ...
          info:
            "Parking junto al Visitor Center de Þingvellir y la parte alta de Almannagjá.",
...

      {
        ...
        parking: {
          ...
          info:
            "Aparcamiento junto al centro de visitantes y frente al acceso a la zona geotérmica.",
...

      {
        ...
        parking: {
          ...
          info:
            "Parking superior junto al Gullfoss Visitor Center y los accesos principales a los miradores.",
...

      {
        ...
        parking: {
          ...
          info:
            "Parking del propio recinto de Secret Lagoon.",
      ...
      /* ===================================================
         TRAYECTO · SECRET LAGOON → HELLA CAMPING
      =================================================== */
